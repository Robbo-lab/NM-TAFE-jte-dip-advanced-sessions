...
class TestProject(unittest.TestCase):
    ...
    # Step 5
    # Add a tests that tests a contact can be created and
    def test_add_contact_to_project(self):
        # arrange
        # Create an organisation & contact
        org = Organisation('NM Tafe')
        contact = Contact('John R', 'tests@example.com')
        ...
        # Challenge tests that you can add a contact to an organisation
